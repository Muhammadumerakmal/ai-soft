...
// trimmed to what this app needs: a small in-memory toast queue with a
// reducer-backed store shared across every useToast() call via listeners.
...
function toast({ ...props }: Toast) {
  ...
  const update = (next: Toast) => dispatch({ type: actionTypes.UPDATE_TOAST, toast: { ...next, id } });
